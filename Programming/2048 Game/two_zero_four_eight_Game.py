"""
Created on Sat Sep 12 00:08:08 2020
@author: ISH KAPOOR
"""
...
class Game(tk.Frame):
    ...
    def make_GUI(self):
        ...
        for i in range(4):
            row = []
            for j in range(4):
                cell_frame = tk.Frame(self.main_grid, bg = c.EMPTY_CELL_COLOR,
    ...
    # Upadte the GUI to match the matrix
    def update_GUI(self):
